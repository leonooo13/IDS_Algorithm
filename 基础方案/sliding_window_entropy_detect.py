                ...
                for canid_i in range(0, 2048):
                    if id_count[canid_i] != 0:
                        ...
                        H_id_i += (float(id_count[canid_i]) / WindowSize) * (
                            math.log(float(WindowSize) / id_count[canid_i],2))
...
if __name__ == '__main__':
    ...
    # W_best = random.randint(5, 70)
    W_best=50
    c=EntropyBased_IntrusionDetect(DoS_Data,k_best,div_best,W_best)
    print(c)
